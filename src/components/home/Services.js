    ...
    const projects = [
      {
        ...
        description: "I can develop a website with only HTML, CSS and raw Javascript. I've built a few websites using only HTML, CSS or HTML, CSS and Javascript"
      },
      {
        id: 2,
        name: "React websites",
        description: "I can develop a website using React router, Firebase Authentication, etc tools. I've built a few websites using ReactJS, Firebase, React Hook Forms, etc."
      },
      {
        id: 3,
        name: "MERN websites",
        description: "I can develop a full-stack e-commerce website using MongoDB, ExpressJS, ReactJS, NodeJS, Stripe, etc tools. I've built a few websites using MERN stack."
      },
    ];
    return (
...
/>
              ...
              <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="card sm:w-full bg-base-100 shadow-xl hover:shadow-2xl hover:shadow-red-800  image-full">
                  <figure>
                    <img src='https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=455&q=80' alt="serviceImage" />
                  </figure>
