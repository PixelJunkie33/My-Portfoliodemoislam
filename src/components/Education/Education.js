  ...
  return (
    <Fade left cascade>
      <div>
        ...
        <div className="my-2 mx-2 hover:my-3">
        ...
        <div className="my-2 mx-2 hover:my-3">
          <div className="border-2 border-black rounded-xl p-3 hover:shadow-2xl hover:shadow-red-500 hover:border-4">
            <h1 className="text-5xl font-bold">Joynal Hazari College, Feni</h1>
            <p className="text-xl">
        ...
        <div className="my-2 mx-2 hover:my-3">
          <div className="border-2 border-black rounded-xl p-3 hover:shadow-2xl hover:shadow-red-500 hover:border-4">
            <h1 className="text-5xl font-bold">Feni Govt Pilot High School</h1>
            <p className="text-xl">
